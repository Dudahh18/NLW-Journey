    ...
    public ResponseEntity<?> updateTrip(@PathVariable UUID id, @RequestBody TripRequestPayload payload){
        ...
        if(trip.isPresent()){
            ...
            if(startsAt.isAfter(endsAt)){
                return ResponseEntity.badRequest().body("A data de início da viagem deve ser anterior à data de término.");
            }
...
@PostMapping
public ResponseEntity<TripCreateResponse> createTrip(@RequestBody TripRequestPayload payload) {
    TripCreateResponse tripCreateResponse = tripService.createTrip(payload);
    if(tripCreateResponse != null) {
